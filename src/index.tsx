import { NativeModules } from 'react-native';
 ...
 const {GenericEscposPrint,BluetoothEscposPrinter, BluetoothTscPrinter }= NativeModules;
...
BluetoothEscposPrinter.BARCODETYPE={
    ...
    JAN8:68,//7<=n<=8
    CODE39:69,//1<=n<=255
    ITF:70,//1<=n<=255(even numbers) // INTERLEAVED25
    CODABAR:71,//1<=n<=255
    CODE93:72,//1<=n<=255
    CODE128:73//2<=n<=255
};
...
BluetoothEscposPrinter.ALIGN={
 ...
 export { GenericEscposPrint,BluetoothEscposPrinter, BluetoothTscPrinter };
