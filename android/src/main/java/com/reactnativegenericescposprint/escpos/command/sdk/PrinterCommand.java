package com.reactnativegenericescposprint.escpos.command.sdk;
...
//***********************************以下函数为公开函数***********************************************************//
    ...
    public static byte[] verticalDirection(){
      byte[] command = new byte[12];
      command[0] = 27;
      command[1] = 76; // page mode

      command[2] = 29;
      command[3] = 80; //Set horizontal and vertical motion units
      command[4] = ((byte) 180);
      command[5] = ((byte) 180);

      command[6] = 27;
      command[7] = 84; //Select printing direction (left to right)
      command[8] = ((byte) 0);

      command[9] = 27;
      command[10] = 84; //Select printing direction (bottom to up)
      command[11] = ((byte) 1);
