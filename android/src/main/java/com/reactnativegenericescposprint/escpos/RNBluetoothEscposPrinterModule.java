...
package com.reactnativegenericescposprint.escpos;
...
import com.reactnativegenericescposprint.BluetoothService;
import com.reactnativegenericescposprint.BluetoothServiceStateObserver;
import com.reactnativegenericescposprint.escpos.command.sdk.Command;
...
public class RNBluetoothEscposPrinterModule extends ReactContextBaseJavaModule
  ...
  public RNBluetoothEscposPrinterModule(ReactApplicationContext reactContext,
    ...
    @ReactMethod
    public void setmService(BluetoothService mService, final Promise promise) {
    ...
    public void printText(String text, @Nullable  ReadableMap options, final Promise promise) {
        try {
            ...
            if (mService.getState() != BluetoothService.STATE_CONNECTED){
              promise.reject("ERRO", "Bluetooth nao conectado ");
              return;
            }
            if (sendDataByte(bytes)) {
                promise.resolve(null);
            } else {
                promise.reject("ERROR","COMMAND_NOT_SEND");
            }
        }catch (Exception e){
...
//                String text = new String(toPrint, Charset.forName(encoding));
    ...
    public void verticalPrint() {
      sendDataByte(PrinterCommand.verticalDirection());
    }
